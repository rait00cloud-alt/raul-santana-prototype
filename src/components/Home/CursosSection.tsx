...
export default function CursosContainer() {
  ...
  return (
    ...
    >
      <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-b from-[#22282b] to-transparent z-30" />

      {/* Mobile Layout */}
      <div className="lg:hidden relative h-[640px] w-full">
        <video
        ...
        >
          <p className="text-white text-xl leading-[30px] tracking-tight font-[BasicCommercialBold] px-8 pb-16 max-w-2xl">
